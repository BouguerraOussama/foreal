                            ...
                            <nav>
                                ...
                                <div id="mobile-menu" class="navbar-wrap d-none d-lg-flex">
                                    <ul>
                                        ...
                                        <li class="show"><a href="#">POINTS SHOP</a></li>
                                            ...
                                            <ul class="minicart">
                                                <li class="d-flex align-items-start">
                                                    ...
                                                    <div class="cart-content">
                                                        <h4>
                                                            <a href="javascript:void(0)">Xbox One Controller</a>
                                                        </h4>
    ...
    require '../controller/merch.php';
     ...
     <script language='Javascript'>
        ...
        prod0des.innerHTML=tab5;
         ...
         basket0.addEventListener("click", function(){
            basket0.href="../model/addpanier.php?id="+tab00;
         });
                }
                if (tab11!="")
       {
        ...
        prod11basket.className="product-cart-action";
         ...
         basket1.addEventListener("click", function(){
            basket1.href="../model/addpanier.php?id="+tab11;
         });
         } 
         if (tab22!="")
         {
        ...
        prod22basket.className="product-cart-action";
         ...
         basket2.addEventListener("click", function(){
            basket2.href="../model/addpanier.php?id="+tab22;
         });
         }
         if (tab33!="")
         {
        ...
        prod33basket.className="product-cart-action";
         ...
         basket3.addEventListener("click", function(){
            basket3.href="../model/addpanier.php?id="+tab33;
         });
         }
         if (tab44!="")
         {
        ...
        prod44basket.className="product-cart-action";
         ...
         basket4.addEventListener("click", function(){
            basket4.href="../model/addpanier.php?id="+tab44;
         });
         }
                </script>
                    ...
                    if(length!="")
                {
                    ...
                    for(var i=0;i<length;i++)
                    {
                       ...
                       const div1=document.createElement("div");
                        ...
                        span.className="new";
                        span.innerHTML="QTE: "+product[i][3];
